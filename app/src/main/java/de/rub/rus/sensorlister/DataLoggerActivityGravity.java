 ...
 */
public class DataLoggerActivityGravity extends DataLoggerActivity {

    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_gravity;
    }
    ...
    protected void storeData() {
        ...
        String filename = "gravity_" + timeStamp + ".txt";
        ...
        try {
            ...
            writer.write("g_x\tg_y\tg_z\ttime abs[ns]\ttime rel[ns]\n");
