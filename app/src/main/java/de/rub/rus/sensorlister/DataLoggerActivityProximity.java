 ...
 */
public class DataLoggerActivityProximity extends DataLoggerActivity {


    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_proximity;
    }
    ...
    protected void storeData() {
        ...
        String filename = "proximity_" + timeStamp + ".txt";
        ...
        try {
            ...
            writer.write("prox\ttime abs[ns]\ttime rel[ns]\n");
