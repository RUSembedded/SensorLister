 ...
 */
public class DataLoggerActivityRotationVector extends DataLoggerActivity {

    @Override
    protected int getContentViewId() { return R.layout.activity_data_logger_rotation_vector; }
    ...
    protected void storeData() {
        ...
        String filename = "rotationVector_" + timeStamp + ".txt";
