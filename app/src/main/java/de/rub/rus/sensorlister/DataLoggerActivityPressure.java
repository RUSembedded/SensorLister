 ...
 */
public class DataLoggerActivityPressure extends DataLoggerActivity {

    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_pressure;
    }
    ...
    protected void storeData() {
        ...
        String filename = "pressure_" + timeStamp + ".txt";
