...
public class DataLoggerActivityAccelerometer extends DataLoggerActivity {

    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_accelerometer;
    }
    ...
    protected void storeData() {
        ...
        String filename = "accelerometer_" + timeStamp + ".txt";
        ...
        try {
            ...
            writer.write("a_x\ta_y\ta_z\ttime abs[ns]\ttime rel[ns]\n");
