 ...
 */
public class DataLoggerActivityRelativeHumidity extends DataLoggerActivity {


    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_relative_humidity;
    }
    ...
    protected void storeData() {
        ...
        String filename = "relativeHumidity_" + timeStamp + ".txt";
