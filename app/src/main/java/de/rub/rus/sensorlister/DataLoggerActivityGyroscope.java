 ...
 */
public class DataLoggerActivityGyroscope extends DataLoggerActivity {

    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_gyroscope;
    }
    ...
    protected void storeData() {
        ...
        String filename = "gyroscope_" + timeStamp + ".txt";
        ...
        try {
            ...
            writer.write("xRate\tyRate\tzRate\ttime abs[ns]\ttime rel[ns]\n");
    ...
    public void onAccuracyChanged(Sensor sensor, int accuracy) {
        // TODO warn user if accuracy is low
    }
