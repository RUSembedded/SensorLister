 ...
 */
public class DataLoggerActivityMagneticField extends DataLoggerActivity {

    @Override
    protected int getContentViewId() {
        return R.layout.activity_data_logger_magnetic_field;
    }

    @Override
    protected void setSensorType() { sensorType = Sensor.TYPE_MAGNETIC_FIELD; }
    ...
    protected void storeData() {
        ...
        String filename = "magneticField_" + timeStamp + ".txt";
        ...
        try {
            ...
            writer.write("mf_x\tmf_y\tmf_z\ttime abs[ns]\ttime rel[ns]\n");
